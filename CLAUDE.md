...
- 2026-09-24 — Версія 2 (див. SPEC «Зміни до ТЗ — 24 вересня»): результат словом одразу, виклик другу, анонімне середнє по Україні через `netlify/functions/pulse.mts`, тест 60 с, одна галочка 18+, без «Форми» й курсиву.
- 2026-09-24 — Деплой з функцією — лише через Netlify CLI або Git (перетягування папки функцій не бачить).
- 2026-09-24 — View Transitions прибрано: у WebKit сторінка «зависала» після переходу.
